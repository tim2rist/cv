...
export const projects: readonly ProjectItem[] = [
  ...
  },
  {
    ...
    description:
      "A comprehensive university capstone web application prioritizing responsive design and user experience. Built with modern frontend frameworks featuring interactive UI components and efficient application state management.",
    role: [
    ...
    tags: ["React", "Capstone", "UX", "Responsive"],
    accent: "emerald",
