...
*   **Artificial Intelligence**: Google Generative AI SDK (`@google/generative-ai`) utilizing the fast and efficient `gemini-1.5-flash` model for the interactive chat widget.
